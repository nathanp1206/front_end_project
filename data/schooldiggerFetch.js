...
var result
pages.forEach((page) => {
    url = `https://api.schooldigger.com/v1.2/schools?st=GA&city=Atlanta&page=${page}&perPage=50&appID=1a0adc5f&appKey=5123024d5711791927204492727917ed`
    fetch(url)
...
test = data.schools
console.log(test.filter(school => school.address.zip == "30327"))